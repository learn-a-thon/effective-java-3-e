package com.example.effectivejava3e.week5.item13;
...
public class Stack implements Cloneable {
    ...
    // TODO elements.clone()이 없다면? stack, copy -> elements (동일한 인스턴스를 참조하는 상황)
    // TODO stack -> elementsS[0, 1]
    // TODO copy -> elementsC[0, 1]
    // TODO elementsS[0] == elementsC[0], 배열은 새로 만들었지만 그 안의 인스턴스까지는 복사되지 않는다. (shallow-copy)
